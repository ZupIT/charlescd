...
// RegenerateSystemToken is an autogenerated mock type for the RegenerateSystemToken type
type RegenerateSystemToken struct {
	mock.Mock
}

// Execute provides a mock function with given fields: id
func (_m *RegenerateSystemToken) Execute(id uuid.UUID) (domain.SystemToken, error) {
	ret := _m.Called(id)
