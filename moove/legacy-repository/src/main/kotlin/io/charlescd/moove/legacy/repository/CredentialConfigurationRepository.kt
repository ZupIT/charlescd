...
interface CredentialConfigurationRepository : JpaRepository<CredentialConfiguration, String> {
    ...
    fun findAllByWorkspaceId(workspaceId: String): List<CredentialConfiguration>

    fun findByIdAndWorkspaceId(id: String, workspaceId: String): Optional<CredentialConfiguration>

    fun findAllByTypeAndWorkspaceId(
