...
class MetricsFeignTest extends Specification {
    MetricsFeignConfig feignErrorDecoderConfiguration
    ErrorDecoder errorDecoder

    void setup() {
        feignErrorDecoderConfiguration = new MetricsFeignConfig()
        errorDecoder = feignErrorDecoderConfiguration.metricsErrorDecoder()
    }
