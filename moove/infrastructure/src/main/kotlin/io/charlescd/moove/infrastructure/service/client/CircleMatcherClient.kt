...
import io.charlescd.moove.infrastructure.configuration.MatcherEncoderConfiguration
...
@FeignClient(name = "circleMatcherClient", url = "\${charlescd.matcher.url}", configuration = [ MatcherEncoderConfiguration::class])
