    ...
    companion object {
        const val BASE_QUERY_STATEMENT = """
                    SELECT deployment_configurations.id                                                        AS deployment_configuration_id,
                           ...
                           deployment_configurations.id                                                        AS deployment_configuration_user_id,
                           deployment_configurations.name                                                      AS deployment_configuration_user_name,
                           deployment_configurations.photo_url                                                 AS deployment_configuration_user_photo_url,
                           deployment_configurations.email                                                     AS deployment_configuration_user_email,
                           deployment_configurations.created_at                                                AS deployment_configuration_user_created_at,
