...
class FindAllUsersInteractorImpl @Inject constructor(
    ...
    private fun convert(page: Page<User>): ResourcePageResponse<SimpleUserWithUserGroupResponse> {
        return ResourcePageResponse(
            content = page.content.map { SimpleUserWithUserGroupResponse.from(it) },
