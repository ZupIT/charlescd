...
data class ComponentHistoryResponse(
    val name: String,
    val moduleName: String,
    val version: String
) {
    companion object {
        fun from(componentHistory: ComponentHistory): ComponentHistoryResponse {
            return ComponentHistoryResponse(
                name = componentHistory.name,
                moduleName = componentHistory.moduleName,
