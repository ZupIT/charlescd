...
class UpdateCircleWithCsvFileInteractorImplTest extends Specification {
    ...
    def "should update a circle with a csv segmentation file"() {
        ...
        2 * deploymentRepository.findActiveByCircleId(circleId) >> [deployment]
    ...
    def "should update a circle with a csv segmentation file with no deployments with status active false"() {
        ...
        2 * deploymentRepository.findActiveByCircleId(circleId) >> []
        0 * buildRepository.findById(deployment.buildId) >> Optional.of(build)
    ...
    private static Build getDummyBuild(String workspaceId, User author, BuildStatusEnum buildStatusEnum, DeploymentStatusEnum deploymentStatusEnum) {
        ...
        def circle = new Circle('f8296cfc-6ae1-11ea-bc55-0242ac130003', 'Circle name', 'f8296df6-6ae1-11ea-bc55-0242ac130003',
                author, LocalDateTime.now(), MatcherTypeEnum.SIMPLE_KV, null, null, null, false, "1a58c78a-6acb-11ea-bc55-0242ac130003", false)
