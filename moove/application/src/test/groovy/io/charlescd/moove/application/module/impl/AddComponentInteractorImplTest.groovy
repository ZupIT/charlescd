...
class AddComponentInteractorImplTest extends Specification {
    ...
    def "should add the component sent in the request"() {
        ...
        def component = new Component("0e6fbc62-41e5-461a-ba11-1765b5d17776", moduleId, "Villager", LocalDateTime.now(), workspaceId, 10, 10, 'host', 'gateway', 'namespace')
    ...
    def "should throw an exception when component already exists"() {
        ...
        def component = new Component("0e6fbc62-41e5-461a-ba11-1765b5d17776", moduleId, "Application", LocalDateTime.now(), workspaceId, 10, 10, 'host',
                'gateway', 'namespace')
