...
public interface RegistryService {
    ...
    void testRegistryConnectivityConfig(DockerRegistryConfigurationEntity entity);

    DockerRegistryConfigurationEntity fromDockerRegistryConfigurationInput(DockerRegistryConfigurationInput input);
