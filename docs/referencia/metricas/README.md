...
Com o Charles, você pode obter métricas de cada um dos seus círculos, possibilitando assim análises sobre a [**saúde**](https://docs.charlescd.io/v/v0.2.7/primeiros-passos/criando-modulos#metricas-de-saude) ****de cada um deles.
