...
O Circle Matcher é um recurso que permite você validar se os seus [**círculos**](https://docs.charlescd.io/v/v0.2.7/referencia/circulos) estão com segmentações coerentes. Você também pode utilizá-lo em suas aplicações para determinar em qual círculo os seus usuários se encaixam.
