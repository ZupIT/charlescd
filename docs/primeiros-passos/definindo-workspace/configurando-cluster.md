...
Depois de finalizar sua configuração, você pode futuramente associá-la a um módulo. Para mais informações, acesse [**Configurações de CD**](https://docs.charlescd.io/referencia/configuracao-cd).
