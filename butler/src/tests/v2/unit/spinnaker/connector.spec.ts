...
import { completeSpinnakerPipeline } from './fixtures'
import { CdTypeEnum } from '../../../../app/v1/api/configurations/enums'

describe('V2 Spinnaker Connector', () => {
  it('should create the correct complete pipeline object', async() => {
    ...
    expect(new SpinnakerConnector().buildSpinnakerPipeline(deployment, activeComponents)).toEqual(completeSpinnakerPipeline)
  })
  ...
  //   ]
  //
  //   expect(new SpinnakerConnector().buildSpinnakerPipeline(deployment, activeComponents)).toBe(completeSpinnakerPipeline)
  // })
})
