...
describe('V2 Spinnaker Deployment Pipeline Builder - remove unused proxy rules', () => {
  ...
  it('should create the correct complete pipeline object with 3 new components overriding all components on active circle and deleting unused components and rules', async() => {
