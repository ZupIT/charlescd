  ...
  it('returns error for malformed payload', async() => {
    ...
    const errorResponse = {
      errors: [
        ...
        {
          detail: expect.stringContaining('"buildImageUrl" with value "imageurl.com2 " fails to match the required pattern'),
          meta: {
            component: 'butler',
            timestamp: expect.anything()
          },
        ...
        {
          detail: expect.stringContaining('"buildImageUrl" with value "imageurl-ends-with-dash.com3-" fails to match the required pattern'),
          meta: {
            component: 'butler',
            timestamp: expect.anything()
          },
