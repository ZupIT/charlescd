...
export class CdConfigurationsRepository extends Repository<CdConfigurationEntity> {
    ...
    public async delete(cdConfigurationId: string): Promise<DeleteResult> {

        return await this.createQueryBuilder('cd_configurations')
            .delete()
            .where('id = :cdConfigurationId', {cdConfigurationId})
            .execute()
