...
public class PercentageValidator implements ConstraintValidator<PercentageConstraint, UpdateSegmentationRequest> {
    ...
    @Override
    public boolean isValid(UpdateSegmentationRequest segmentation, ConstraintValidatorContext constraintValidatorContext) {
