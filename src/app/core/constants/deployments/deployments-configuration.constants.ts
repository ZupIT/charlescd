export const DeploymentsConfigurationConstants = {
  ...
  MOOVE_URL: 'https://backend-darwin.apirealwave.io',
  ...
  DARWIN_DEPLOY_URL: 'https://darwin-deploy.zup.com.br',
  DARWIN_NOTIFICATION_URL: 'https://darwin-deploy.zup.com.br/notifications'
}
