...
export function buildParameters(params: ParameterForm[]) {
  if (stryMutAct_9fa48("3533")) {
    ...
    stryCov_9fa48("3533");
    return reduce<ParameterForm, ParameterPayload>(params, (acc, {
      key = stryMutAct_9fa48("3534") ? "Stryker was here!" : (stryCov_9fa48("3534"), ''),
      value = stryMutAct_9fa48("3535") ? "Stryker was here!" : (stryCov_9fa48("3535"), '')
    }) => {
