...
import { COLOR_MOUNTAIN_MEADOW, COLOR_PURPLE_HEART, COLOR_RED_ORANGE, COLOR_FREE_SPEECH_BLUE } from 'core/assets/colors';
export const light = {};
export const dark = stryMutAct_9fa48("68") ? {} : (stryCov_9fa48("68"), {
  background: ({
