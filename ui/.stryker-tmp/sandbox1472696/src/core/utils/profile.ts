...
export const profileKey = stryMutAct_9fa48("2205") ? "" : (stryCov_9fa48("2205"), 'profile');
...
export const clearProfile = stryMutAct_9fa48("2210") ? () => undefined : (stryCov_9fa48("2210"), (() => {
  const clearProfile = () => localStorage.removeItem(profileKey);
