...
export interface Reducer {
  ...
  workspaces: (state: WorkspaceState, action: WorkspacesActionTypes) => WorkspaceState;
  users: (state: UserState, action: UsersActionTypes) => UserState;
  notification: (state: NotificationState, action: NotificationActionTypes) => NotificationState;
  userGroups: (state: UserGroupState, action: UserGroupsActionTypes) => UserGroupState;
  modules: (state: ModuleState, action: ModulesActionTypes) => ModuleState;
  tokens: (state: TokensState, action: TokensActionTypes) => TokensState;
}