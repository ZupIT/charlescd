...
test('render default (unchecked) Checkbox', () => {
  ...
  expect(checkboxIcon).toHaveStyle(
    `background: ${theme.select.checkbox.unchecked.background}`
  )
  expect(checkboxIcon).toHaveStyle(
    `border: 1px solid ${theme.select.checkbox.unchecked.borderColor}`
  )
...
test('render checked Checkbox', () => {
  ...
  expect(checkboxIcon).toHaveStyle(
    `background: ${theme.select.checkbox.checked.background}`
  );
